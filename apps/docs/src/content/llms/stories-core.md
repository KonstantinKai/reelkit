...
| `kStoriesRingSize`, `kStoriesRingListRingSize`, `kStoriesCardRingSize` | `number`                                          | Default ring diameters in px every binding draws: 68 single ring, 64 ring list, 52 carousel card. Pass as `size` to match the players                                                                                       |
