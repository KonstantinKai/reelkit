...
`desktopLayout="carousel"` सेट करें तो player का layout Instagram वेब जैसा हो जाता है: active story अपने सामान्य आकार में बीच में रहती है, और हर तरफ़ ज़्यादा से ज़्यादा दो पड़ोसी groups छोटे, धुंधले कार्ड के रूप में दिखते हैं। किसी कार्ड पर क्लिक करने से वह group खुलता है, और group बदलते समय कार्ड बगल में खिसकते हैं। ring list को दिया जाने वाला वही `viewedState` map पास करें, तो पूरे देखे गए group के कार्ड पर फीकी ring दिखती है।
...
- **हर कार्ड दिखाता है कि group कहाँ से खुलेगा**: इस session में जिस story पर उसे छोड़ा गया था, वरना वह story जो `resumeStoryIndex` लौटाता है। कार्ड पर वीडियो का poster या खुद इमेज दिखती है। जिस story में दोनों में से कुछ नहीं है, जैसे gradient पर टेक्स्ट वाली story, उसे आपका `renderSlide` player के आकार में बनाता है और फिर छोटा करके दिखाया जाता है; बिना poster वाले वीडियो पर कार्ड का background दिखता है।
...
| `desktopLayout` | `'single' \| 'carousel'` | 'single' | डेस्कटॉप layout। 'carousel' active story के बगल में पड़ोसी groups को preview कार्ड के रूप में दिखाता है और groups के बीच slide करता है। फ़ोन पर story हमेशा अकेली दिखती है। |
| `viewedState` | `Map<string, number>` | - | हर author id के लिए देखी गई stories की गिनती, viewedCounts() से। पूरे देखे गए group के carousel कार्ड पर फीकी ring दिखती है। |
