...
| Prop | टाइप | डिफ़ॉल्ट | विवरण |
| --- | --- | --- | --- |
| `signals` | `Subscribable[]` | `required` | जिन signals को subscribe करना है। इनमें से किसी की भी सूचना children फ़ंक्शन को दोबारा चलाती है — और सिर्फ़ उसी को, parent को कभी नहीं। बाद के render में दिया गया अलग signal, जिसकी जगह वह लेता है उसके बदले follow किया जाता है। |
