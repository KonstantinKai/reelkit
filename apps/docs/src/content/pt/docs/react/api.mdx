...
| Prop | Tipo | Padrão | Descrição |
| --- | --- | --- | --- |
| `signals` | `Subscribable[]` | `obrigatório` | Sinais a assinar. Qualquer aviso de um deles roda a função dos filhos de novo — só ela, nunca o componente pai. Um sinal diferente em uma renderização posterior passa a ser acompanhado no lugar do que ele substituiu. |
