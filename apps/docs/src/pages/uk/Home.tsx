...
const highlights = [
  {
    ...
    description: 'Витримує 10 000+ елементів. У DOM одночасно лише 3 слайди.',
  ...
  },
  {
    ...
    description: 'Жодних рантайм-залежностей. Ядро — близько 10.1 кБ у gzip.',
...
const moreFeatures = [
  ...
  },
  {
    ...
    title: 'Навігація з клавіатури',
    color: 'text-primary-500',
  },
  {
    icon: <Layers className="w-4 h-4" />,
    title: 'Незалежний від фреймворку',
    color: 'text-emerald-500',
  },
  {
    icon: <Code2 className="w-4 h-4" />,
    title: 'TypeScript передусім',
    color: 'text-sky-500',
  },
  {
    icon: <Paintbrush className="w-4 h-4" />,
    title: 'Headless + готові стилі',
    color: 'text-accent-500',
  },
  {
  ...
  },
  {
    ...
    title: 'Стан в URL, яким можна ділитися',
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-4 max-w-lg">
                Слайдер по одному елементу для{' '}
                <span className="text-primary-600 dark:text-primary-400 font-semibold">
                  стрічок у стилі TikTok / Instagram Reels
                </span>{' '}
                та історій
              </p>

              <p className="text-base text-slate-500 dark:text-slate-400 mb-6 max-w-lg">
                Незалежний від фреймворку, віртуалізований, орієнтований на
                дотик. Створений для вертикальних відеострічок, переглядачів
                історій і повноекранних галерей.
              </p>
            ...
            <div className="flex-shrink-0">
              ...
              <p className="text-center text-xs text-slate-400 dark:text-slate-500 mt-3">
                Демо наживо — гортайте стрілками
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
            ...
            — вертикальні відеострічки, як в Instagram Reels і TikTok. По одному
            елементу за раз, свайп — і далі.
          </p>
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            <span className="font-semibold text-slate-800 dark:text-slate-200">
              Kit
            </span>{' '}
            — модульний набір пакетів. Беріть headless-ядро для повного
            контролю, прив’язки до фреймворків для швидкого старту або готові
            оверлеї для відеоплеєрів і галерей зображень.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Простий API</h2>
            <p className="text-lg text-slate-600 dark:text-slate-400">
              Кілька рядків коду — і все працює
            </p>
          </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              Модульна екосистема — беріть те, що потрібно
            </p>
          </div>
          ...
          <div className="max-w-lg mx-auto mb-6">
            <div className="relative p-6 rounded-2xl border-2 border-primary-400 dark:border-primary-500 bg-gradient-to-br from-primary-50 to-accent-50 dark:from-primary-950/40 dark:to-accent-950/30 shadow-lg shadow-primary-500/10">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm ml-12">
                Рушій слайдера без прив’язки до фреймворку — віртуалізація,
                жести, клавіатура, колесо миші, сигнали. Нуль залежностей.
              </p>
            </div>
          </div>
            ...
            {[
              {
                framework: 'React',
                pkg: '@reelkit/react',
                desc: 'Компоненти, хуки та мости сигналів',
                color: 'sky',
                extensions: [
              ...
              },
              {
                framework: 'Angular',
                pkg: '@reelkit/angular',
                desc: 'Автономні компоненти з реактивністю на сигналах',
                color: 'rose',
                extensions: [
                  {
      ...
      <section className="py-20 bg-slate-900 dark:bg-slate-800/50 border-t border-slate-800 dark:border-slate-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 text-lg mb-8">
            Загляньте в документацію та приклади, щоб зібрати свій перший
            слайдер.
          </p>
