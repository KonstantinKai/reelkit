...
<LightboxUrlOverlay controller={photo} images={images} />`}
        ...
        <ul className="mt-4 mb-4 list-disc pl-6 space-y-1 text-slate-600 dark:text-slate-400">
          ...
          <li>
            ...
            параметр на місці й лишає вас у галереї. Готові адаптери роутерів
            ручаються за перехід за посиланням на тій самій сторінці; власний
            адаптер, який не може сказати, як з’явився запис, теж отримує
            закриття на місці, і в історії лишається дублікат сторінки — один
            крок назад тоді ніби нічого не робить, але нічого й не відкриває.
          </li>
          <li>
