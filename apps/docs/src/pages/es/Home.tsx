...
const moreFeatures = [
  ...
  },
  {
    ...
    title: 'TypeScript ante todo',
    color: 'text-sky-500',
  },
  {
    icon: <Paintbrush className="w-4 h-4" />,
    title: 'Headless + con estilos',
    color: 'text-accent-500',
  },
  {
  ...
  },
  {
    ...
    title: 'Estado en la URL compartible',
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-4 max-w-lg">
                Slider de un solo elemento para{' '}
                <span className="text-primary-600 dark:text-primary-400 font-semibold">
                  experiencias al estilo de TikTok / Instagram Reels
                </span>
              </p>

              <p className="text-base text-slate-500 dark:text-slate-400 mb-6 max-w-lg">
                Independiente del framework, virtualizado y pensado para el
                tacto. Hecho para feeds verticales de vídeo, visores de stories
                y galerías a pantalla completa.
              </p>
      ...
      <section className="py-24 bg-white dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
            ...
            — feeds verticales de vídeo como los de Instagram Reels y TikTok. Un
            contenido cada vez; desliza para pasar al siguiente.
          </p>
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            <span className="font-semibold text-slate-800 dark:text-slate-200">
              Kit
            </span>{' '}
            — un conjunto modular de paquetes. Usa el core headless para tener
            control total, los bindings de framework para empezar rápido o los
            overlays listos para usar para reproductores de vídeo y galerías de
            imágenes.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-lg mx-auto mb-6">
            <div className="relative p-6 rounded-2xl border-2 border-primary-400 dark:border-primary-500 bg-gradient-to-br from-primary-50 to-accent-50 dark:from-primary-950/40 dark:to-accent-950/30 shadow-lg shadow-primary-500/10">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm ml-12">
                Motor de slider independiente del framework — virtualización,
                gestos, teclado, rueda del ratón, señales. Sin dependencias.
              </p>
            </div>
          </div>
            ...
            {[
              {
                framework: 'React',
                pkg: '@reelkit/react',
                desc: 'Componentes, hooks y puentes de señales',
                color: 'sky',
                extensions: [
              ...
              },
              {
                framework: 'Angular',
                pkg: '@reelkit/angular',
                desc: 'Componentes standalone con reactividad basada en señales',
                color: 'rose',
                extensions: [
                  {
              ...
              },
              {
                framework: 'Vue',
                pkg: '@reelkit/vue',
                desc: 'Componentes y composables para Vue 3',
                color: 'emerald',
                extensions: [
                  {
      ...
      <section className="py-20 bg-slate-900 dark:bg-slate-800/50 border-t border-slate-800 dark:border-slate-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 text-lg mb-8">
            Consulta la documentación y los ejemplos para crear tu primer
            slider.
          </p>
