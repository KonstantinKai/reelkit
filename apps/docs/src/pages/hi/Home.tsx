...
const highlights = [
  ...
  },
  {
    ...
    unit: 'fps',
    title: 'टच सबसे पहले',
    description: 'momentum और snap points के साथ असली जैसे स्वाइप जेस्चर।',
...
const moreFeatures = [
  ...
  },
  {
    ...
    title: 'फ़्रेमवर्क से स्वतंत्र',
    color: 'text-emerald-500',
  },
  {
    icon: <Code2 className="w-4 h-4" />,
    title: 'TypeScript सबसे पहले',
    color: 'text-sky-500',
  },
  {
  ...
  },
  {
    ...
    title: 'तैयार कंपोनेंट',
    color: 'text-rose-400',
  },
  {
    icon: <Link2 className="w-4 h-4" />,
    title: 'शेयर होने वाली URL स्टेट',
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-4 max-w-lg">
                <span className="text-primary-600 dark:text-primary-400 font-semibold">
                  TikTok/Instagram Reels जैसे
                </span>{' '}
                अनुभव के लिए सिंगल-आइटम स्लाइडर
              </p>

              <p className="text-base text-slate-500 dark:text-slate-400 mb-6 max-w-lg">
                फ़्रेमवर्क से स्वतंत्र, वर्चुअलाइज़्ड, टच सबसे पहले। वर्टिकल
                वीडियो फ़ीड, story व्यूअर और फ़ुलस्क्रीन गैलरी के लिए बना।
              </p>
      ...
      <section className="py-24 bg-white dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
            ...
            — Instagram Reels और TikTok जैसी वर्टिकल वीडियो फ़ीड। एक समय में एक
            कंटेंट, आगे बढ़ने के लिए स्वाइप करें।
          </p>
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            <span className="font-semibold text-slate-800 dark:text-slate-200">
              Kit
            </span>{' '}
            — पैकेज का एक modular सेट। पूरे नियंत्रण के लिए headless core, जल्दी
            सेटअप के लिए फ़्रेमवर्क bindings, या वीडियो प्लेयर और इमेज गैलरी के
            लिए तैयार overlays इस्तेमाल करें।
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">आसान API</h2>
            <p className="text-lg text-slate-600 dark:text-slate-400">
              बस कुछ लाइन के कोड से शुरू करें
            </p>
          </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              एक modular ecosystem — जो चाहिए, वही चुनें
            </p>
          </div>
          ...
          <div className="max-w-lg mx-auto mb-6">
            <div className="relative p-6 rounded-2xl border-2 border-primary-400 dark:border-primary-500 bg-gradient-to-br from-primary-50 to-accent-50 dark:from-primary-950/40 dark:to-accent-950/30 shadow-lg shadow-primary-500/10">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm ml-12">
                फ़्रेमवर्क से स्वतंत्र स्लाइडर इंजन — वर्चुअलाइज़ेशन, जेस्चर,
                कीबोर्ड, व्हील, सिग्नल। कोई dependency नहीं।
              </p>
            </div>
          </div>
            ...
            {[
              {
                framework: 'React',
                pkg: '@reelkit/react',
                desc: 'कंपोनेंट, hooks और signal bridges',
                color: 'sky',
                extensions: [
              ...
              },
              {
                framework: 'Angular',
                pkg: '@reelkit/angular',
                desc: 'signal पर आधारित reactivity वाले standalone कंपोनेंट',
                color: 'rose',
                extensions: [
                  {
              ...
              },
              {
                framework: 'Vue',
                pkg: '@reelkit/vue',
                desc: 'Vue 3 के लिए कंपोनेंट और composables',
                color: 'emerald',
                extensions: [
                  {
      ...
      <section className="py-20 bg-slate-900 dark:bg-slate-800/50 border-t border-slate-800 dark:border-slate-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 text-lg mb-8">
            अपना पहला स्लाइडर बनाने के लिए डॉक्स और उदाहरण देखें।
          </p>
