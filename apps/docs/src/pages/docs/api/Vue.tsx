  ...
  return (
    <div className="docs-page">
      <div className="coming-soon-banner">
        <strong>Coming Soon</strong> — Vue bindings are under development. The API below is planned but not yet available.
      </div>
      <h1 className="docs-title">Vue API</h1>
      <p className="docs-description">
        The <code>@reelkit/vue</code> package provides Vue 3 composables and components.
      </p>

      <section className="docs-section">
        <h2>Reel Component</h2>
        <p>
          The main container component that provides slider context.
        </p>
        <CodeBlock
          title="App.vue"
          lang="vue"
    ...
    <ReelIndicator :count="items.length" />
        ...
        <table className="api-table">
          ...
          <tbody>
            ...
            <tr>
              <td><code>enable-wheel</code></td>
              <td><code>boolean</code></td>
              <td><code>false</code></td>
              <td>Enable wheel scroll</td>
            </tr>
            <tr>
              <td><code>use-nav-keys</code></td>
              <td><code>boolean</code></td>
        ...
        <table className="api-table">
          ...
          <tbody>
            <tr>
              <td><code>@after-change</code></td>
              <td><code>(index: number, rangeIndex: number)</code></td>
              <td>After slide change</td>
            </tr>
            <tr>
              <td><code>@before-change</code></td>
              <td><code>(index: number, nextIndex: number)</code></td>
        ...
        <table className="api-table">
          ...
          <tbody>
            <tr>
              ...
              <td><code>{'{ index, indexInRange, size }'}</code></td>
              <td>Slide content</td>
            </tr>
          </tbody>
        </table>
      ...
      <section className="docs-section">
        <h2>API Access</h2>
        <p>
          Access the controller via template ref:
        </p>
        <CodeBlock
          lang="vue"
          code={`<script setup lang="ts">
