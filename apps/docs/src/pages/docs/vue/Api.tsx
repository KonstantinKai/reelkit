...
export default function VueApi() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-2">Reel</h2>
      ...
      <section className="mb-12">
        <h3 className="text-lg font-semibold mb-3">Slots</h3>
        <CodeBlock
  ...
  <ReelIndicator />
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">ReelExpose</h2>
        <p className="text-slate-600 dark:text-slate-400 mb-4">
...
<template>
  <Reel ref="reelRef" :count="100">
    <template #item="{ index }">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-2">ReelIndicator</h2>
        <p className="text-slate-600 dark:text-slate-400 mb-4">
          Tag:{' '}
          <code className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 rounded text-xs font-mono">
            {'<ReelIndicator>'}
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-2">SwipeToClose</h2>
        <p className="text-slate-600 dark:text-slate-400 mb-4">
          Tag:{' '}
          <code className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 rounded text-xs font-mono">
            {'<SwipeToClose>'}
        ...
        <h3 className="text-lg font-semibold mt-6 mb-3">Slots</h3>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-700">
...
function jump(index: number) {
  ctx?.goTo(index, true);
      ...
      <section className="mb-12">
        ...
        <h3 className="text-xl font-semibold mb-3">useBodyLock</h3>
        <p className="text-slate-600 dark:text-slate-400 mb-4">
...
useBodyLock(true);`}
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3">useFullscreen</h3>
        <p className="text-slate-600 dark:text-slate-400 mb-4">
...
const { isFullscreen, request, exit, toggle } = useFullscreen({
  elementRef: containerRef,
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3">useSoundState</h3>
        <p className="text-slate-600 dark:text-slate-400 mb-4">
          Access the current{' '}
          <code className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 rounded text-xs font-mono">
            SoundController
...
sound.toggle(); // Toggle muted state`}
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">SoundProvider</h2>
        <p className="text-slate-600 dark:text-slate-400 mb-4">
          Tag:{' '}
          <code className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 rounded text-xs font-mono">
            {'<SoundProvider>'}
