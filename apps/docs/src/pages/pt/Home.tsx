...
const highlights = [
  ...
  },
  {
    ...
    description: 'Gestos de deslize nativos, com inércia e pontos de encaixe.',
...
const moreFeatures = [
  ...
  },
  {
    ...
    title: 'Independente de framework',
    color: 'text-emerald-500',
  },
  {
  ...
  },
  {
    ...
    title: 'Headless + estilos prontos',
    color: 'text-accent-500',
  },
  {
  ...
  },
  {
    ...
    title: 'Estado na URL para compartilhar',
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-4 max-w-lg">
                Slider de um item por vez para{' '}
                <span className="text-primary-600 dark:text-primary-400 font-semibold">
                  experiências no estilo TikTok / Instagram Reels
                </span>{' '}
                e stories
              </p>

              <p className="text-base text-slate-500 dark:text-slate-400 mb-6 max-w-lg">
                Independente de framework, virtualizado, pensado para o toque.
                Feito para feeds de vídeo vertical, visualizadores de stories e
                galerias em tela cheia.
              </p>
            ...
            <div className="flex-shrink-0">
              ...
              <p className="text-center text-xs text-slate-400 dark:text-slate-500 mt-3">
                Demonstração ao vivo — use as setas
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white dark:bg-slate-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
            ...
            — feeds de vídeo vertical como os do Instagram Reels e do TikTok. Um
            conteúdo por vez, e um deslize leva ao próximo.
          </p>
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            <span className="font-semibold text-slate-800 dark:text-slate-200">
              Kit
            </span>{' '}
            — um conjunto modular de pacotes. Use o core headless para ter
            controle total, os bindings de framework para começar rápido, ou os
            overlays prontos para players de vídeo e galerias de imagens.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">API simples</h2>
            <p className="text-lg text-slate-600 dark:text-slate-400">
              Algumas linhas de código e está funcionando
            </p>
          </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              Um ecossistema modular — pegue só o que precisar
            </p>
          </div>
          ...
          <div className="max-w-lg mx-auto mb-6">
            <div className="relative p-6 rounded-2xl border-2 border-primary-400 dark:border-primary-500 bg-gradient-to-br from-primary-50 to-accent-50 dark:from-primary-950/40 dark:to-accent-950/30 shadow-lg shadow-primary-500/10">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm ml-12">
                Motor de slider independente de framework — virtualização,
                gestos, teclado, roda do mouse, sinais. Zero dependências.
              </p>
            </div>
          </div>
            ...
            {[
              {
                framework: 'React',
                pkg: '@reelkit/react',
                desc: 'Componentes, hooks e pontes de sinais',
                color: 'sky',
                extensions: [
              ...
              },
              {
                framework: 'Angular',
                pkg: '@reelkit/angular',
                desc: 'Componentes standalone com reatividade baseada em sinais',
                color: 'rose',
                extensions: [
                  {
              ...
              },
              {
                framework: 'Vue',
                pkg: '@reelkit/vue',
                desc: 'Componentes e composables para Vue 3',
                color: 'emerald',
                extensions: [
                  {
      ...
      <section className="py-20 bg-slate-900 dark:bg-slate-800/50 border-t border-slate-800 dark:border-slate-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 text-lg mb-8">
            Confira a documentação e os exemplos para montar seu primeiro
            slider.
          </p>
