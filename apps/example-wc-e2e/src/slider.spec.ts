...
test.describe('Reel WC - Rendering', () => {
...
test.describe('Reel WC - Button Navigation', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
  });
...
test.describe('Reel WC - Keyboard Navigation', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
  });
...
test.describe('Reel WC - Touch Gestures', () => {
...
test.describe('Reel WC - Animation', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
  });
...
test.describe('Reel WC - Indicator', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
  });
