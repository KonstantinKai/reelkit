...
<p>
  ...
  <img src="https://img.shields.io/badge/gzip-4.8%20kB-6366f1" alt="Bundle size" />
  <img src="https://img.shields.io/badge/coverage-96%25-brightgreen" alt="Coverage" />
  <a href="https://github.com/KonstantinKai/reelkit"><img src="https://img.shields.io/github/stars/KonstantinKai/reelkit?style=social" alt="Star on GitHub" /></a>
</p>

React bindings for `@reelkit/core`. Drop in a `<Reel>` component, give it a slide count and a render function — it handles virtualization, gestures, and keyboard/wheel input. ~4.8 kB gzip.
