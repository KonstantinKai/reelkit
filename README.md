...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/core%20gzip-9.0%20kB-6366f1" alt="Bundle size" />
  <br/>
...
- **Zero dependencies** — ~9.0 kB gzip core
...
| ---------------------------------------------------------------------- | --------------------------------- | --------- |
| [@reelkit/core](packages/reelkit-core)                                 | Framework-agnostic slider engine  | 9.0 kB    |
| [@reelkit/react](packages/reelkit-react)                               | React components and hooks        | 4.7 kB    |
...
| [@reelkit/vue](packages/reelkit-vue)                                   | Vue 3 components and composables  | 4.9 kB    |
| [@reelkit/vue-reel-player](packages/reelkit-vue-reel-player)           | Full-screen video reel player     | 6.2 kB    |
| [@reelkit/vue-lightbox](packages/reelkit-vue-lightbox)                 | Image & video gallery lightbox    | 4.1 kB    |
