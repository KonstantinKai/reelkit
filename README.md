...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/core%20gzip-9.6%20kB-6366f1" alt="Bundle size" />
  <br/>
...
- **Zero dependencies** — ~9.6 kB gzip core
...
| ---------------------------------------------------------------------- | --------------------------------- | --------- |
| [@reelkit/core](packages/reelkit-core)                                 | Framework-agnostic slider engine  | 9.6 kB    |
...
| [@reelkit/stories-core](packages/reelkit-stories-core)                 | Framework-agnostic stories engine | 1.9 kB    |
