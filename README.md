...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/core%20gzip-4.1%20kB-6366f1" alt="Bundle size" />
  <br/>
...
- **Zero dependencies** — ~4.1 kB gzip core
...
| -------------------------------------------------------------------- | -------------------------------- | --------- |
| [@reelkit/core](packages/reelkit-core)                               | Framework-agnostic slider engine | 4.1 kB    |
